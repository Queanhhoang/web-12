const ShoppingCartItem = ({image, productName, category, price, amount, add, decrease,remove, productId}) => {
    return (
        <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
            <img src={image} className="w-[10em] h-[10em]"/>
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                    <div className="flex items-center border-gray-100">
                        ...
                        <input className="h-8 w-8 border bg-white text-center text-xs outline-none items-center" type="number" value={amount} min="1" />
